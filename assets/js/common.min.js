...
function slide_spesifics() {
  let slider = $('.slider--works');
  slider.slick({
    adaptiveHeight: true,
    arrows: true,
    slidesToShow: 1,
  ...
  // $('.slide-specifics__nav').slick({
  //   slidesToShow: this.get_length('.slide-specifics__link'),
  //   slidesToScroll: 1,
  //   asNavFor: '.slide-specifics__left',
  //   dots: false,
  //   focusOnSelect: true,
  //   vertical: true
  // });
  // $('.slides-nav.slides-nav--specifics .prev').click(function(){
  //   slider.slick('slickPrev');
  // });
  // $('.slides-nav.slides-nav--specifics .next').click(function(){
